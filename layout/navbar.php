<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="index.php" data-aos="fade-right" data-aos-duration="1000">Hornbill Blog</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0" data-aos="fade-left" data-aos-duration="1000">
        <?php if (isset($_SESSION['user'])) :?>
          ...
          <li class="nav-item">
            <form method="post">
              <button name="signOutBtn" class="nav-link btn" onclick="return confirm('Are you sure to sign out?')">Sign Out</button>
            </form>
          </li>
        <?php else: ?>
          <li class="nav-item">
